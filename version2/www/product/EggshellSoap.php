    ...
    <div class="wrapper style5">
        <article class="content container 75%">
            <div class="row not-mobile">
                <div class="5u">
                    <img id="productImage" class="10u" src="images/PIC00-8.png">
                    <!--div class="row"-->
                    <h4>售價　TWD NT$ 380 / 120</h4>
                    <!--/div-->
                </div>
                <div class="7u">
                    <div class="row">
                        <div class="12u fr42">
                            <ul class="fr49 item">
                                <li id="best">BEST</li>
                                <li>
                                    <h3>Nano Soap -Eggshell 100g / 25g</h3>
                                </li>
                            </ul>
                            <ul class="item">
                                <li>
                            ...
                            <p>輕鬆去除老廢角質，運用超柔細
                                <font style="color:darkorange;font-weight: 500">高分子蛋殼膜素完全感受不到顆粒粗糙感。</font>完全符合定期清除沉積毛孔，更替角質層重現肌膚柔嫩會呼吸的柔細與光澤。
                            ...
                            <div class="row fr403">
                                <div class="8u">
                                    <div class="row no-collapse">
                                        ...
                                        <div class="3u"><img class="12u " src="images/ICON6-Eggshell (Element).png"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row fr330 fr403">
                            <div class="4u">
                                <table class="aromas">
                                    ...
                                    <tr>
                                        <td><input type="radio" name="product" value="egg100" onChange="selectionChanged()"
                                            <?php echo (!isset($_POST['product']))||($_POST['product']=="egg100")? "checked":""; ?> >
                                        </td>
                                        <td><input type="radio" name="product" value="egg25" onChange="selectionChanged()"
                                            <?php echo ($_POST['product']=="egg25")? "checked":""; ?> >
                                        </td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <div class="row 25% fr42 fr321" id="labeling">
                        ...
                        <ul>
                            ...
                            <li>NSP天然淨化因子(奈米矽片)，棕櫚油，棕仁油，椰子油，天然甘油，蓖麻油，
                                <font style="color:darkorange;font-weight: 500">高分子蛋殼膜素</font>。</li>
                        </ul>
            ...
            <div class="row only-mobile">
                <div class="12u">
                    <img class="8u" id="productImageB" src="images/PIC00-8.png">
                </div>
                    ...
                    <div class="row">
                        <div class="10u fr42">
                            <div class="row no-collapse">
                                ...
                                <img class="2u " src="images/ICON6-Eggshell (Element).png">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="12u">
                                <table class="6u aromas">
                                    ...
                                    <tr>
                                        <td><input type="radio" name="product" value="egg100" onChange="selectionChangedB()"
                                            <?php echo (!isset($_POST['product']))||($_POST['product']=="egg100")? "checked":""; ?> >
                                        </td>
                                        <td><input type="radio" name="product" value="egg25" onChange="selectionChangedB()"
                                            <?php echo ($_POST['product']=="egg25")? "checked":""; ?> >
                                        </td>
                                    </tr>
                                </table>
