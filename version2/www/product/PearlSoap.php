	...
	<!-- Home -->
		<div class="wrapper style5">
	      <article class="content container 75%">
		     <div class="row">
			    <div class="4u 6u(2) 12u(3)"><img id="productImage" class="12u 6u(3)" src="images/PIC00-9.png"></div>
				<div class="8u 10u(2) 12u(3)">
                   ...
                   <div class="row 25% fr42">
                      <ul class="12u item">
                         ...
                         <li><h3>Pearl 100g / 25g<h3></li>
                      </ul>
                      <ul class="12u item">
                         <li><h4>珍珠矽皂</h4><li>
                         <li><h4>[ 逆青春駐顏保養系列 ]</h4><li>
                      </ul>
                      <div class="12u item"><p>只要青春不要痘，高規格採頂級食用奈米珍珠元素，深層清潔暨保養一次到位，以最新技術用深層清潔的神奇力量，珍珠修護元素加持呵護您的每一吋肌膚，重現肌膚的柔細與光澤。</p></div>
                   </div>
                   <div class="row 25% fr403">
                      <div class="7u 4u(3)">
                         <div class="row no-collapse">
                            ...
                            <div class="3u"><img class="12u 10u(3)" src="images/ICON7-Pearl (Element).png"></div>
                         </div>
                      </div>
                   </div>
                   <div class="row 50%">
                      <span class="price">售價　TWD NT$ 420 / $ 135</span>
                   </div>
                   <form action="<?php echo $_SERVER[PHP_SELF]; ?>" method="post" id="orderForm">
                   <div class="row 25%">
                      <div class="8u"><span>請選擇</span>
                         <div class="row 25% no-collapse">
                            <div class="2u"><label><img class="12u" src="images/ICON Peral100g 200x250.png"><br>
                               <input type="radio" name="product" value="pearl100" onChange="selectionChanged()"
                               <?php echo (!isset($_POST['product']))||($_POST['product']=="pearl100")? "checked":""; ?> ></label>
                            </div>
                            <div class="2u"><label><img class="12u" src="images/ICON Peral25g 200x250.png"><br>
                               <input type="radio" name="product" value="pearl25" onChange="selectionChanged()"
                               <?php echo ($_POST['product']=="pearl25")? "checked":""; ?> ></label>
                            </div>
                         </div>
                      </div> 
		   </div> <!-- row 25%-->				   
                   ...
                   <div class="row 25% fr42 fr321" id="labeling">
                      <span>貼心提醒：由於商品每批限量製作，因此顏色將會有些許誤差，屬正常範圍。</span>
                         <ul><p>〔天然成分〕</p>
                            <li>NSP天然淨化因子(奈米矽片)，棕櫚油，棕仁油，椰子油，天然產生之甘油，蓖麻油，蘆薈油，頂級食用奈米珍珠粉。</li>
                         </ul>
                         <ul><p>〔使用方法〕</p>
