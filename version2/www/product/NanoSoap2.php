    ...
    <div class="wrapper style5">
        <article class="content container 75%">
            <div class="row not-mobile">
                <div class="5u">
                    <img id="productImage" class="10u" src="images/25-1-1 326x326.png">
                    <h4>售價　TWD NT$ 80</h4>
                </div>
                <div class="7u">
                    <div class="row">
                        <div class="12u fr42">
                            <ul class="fr49 item">
                                <li id="best">BEST</li>
                                <li>
                                    <h3>Nano Soap -Natural essential oils 25g</h3>
                                </li>
                            </ul>
                            <ul class="item">
                                <li>
                        ...
                        <div class="row fr330 fr403">
                            <div class="8u">
                                <table class="aromas">
                                    ...
                                    <tr>
                                        <td><input type="radio" name="product" value="gardenia25" onChange="selectionChanged()"
                                            <?php echo (!isset($_POST[ 'product']))||($_POST[ 'product']=="gardenia25" )? "checked": ""; ?> >
                                        </td>
                                        <td><input type="radio" name="product" value="rose25" onChange="selectionChanged()"
                                            <?php echo ($_POST[ 'product']=="rose25" )? "checked": ""; ?> >
                                        </td>
                                        <td><input type="radio" name="product" value="lemongrass25" onChange="selectionChanged()"
                                            <?php echo ($_POST[ 'product']=="lemongrass25" )? "checked": ""; ?> >
                                        </td>
                                        <td><input type="radio" name="product" value="cypress25" onChange="selectionChanged()"
            ...
            <div class="row only-mobile">
                <div class="12u">
                    <img class="9u" id="productImageB" src="images/25-1-1 326x326.png">
                </div>
