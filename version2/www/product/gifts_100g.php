	...
	<!-- Home -->
		<div class="wrapper style5">
	      <article class="content container 75%">
				 <div class="row">
					<div class="4u 6u(2) 12u(3)"><img id="productImage" class="12u 6u(3)" src="images/PIC00-10-2.png"></div>
					<div class="8u 10u(2) 12u(3)">
                       ...
                       <div class="row 25% fr42">
                          <ul class="12u item">
                                ...
                                <li><h3>Vibrant skin set 100g</h3></li>
                          </ul>
                          <ul class="12u item">
                                <li><h4>超彈潤 植淬賦活組</h4><li>
                                <li><h4>[ 任選系列 ]</h4><li>
                          </ul>
                          <div class="12u item">以呈現包裝最初樣子的設計概念來表達肌膚也能擁有完美裸肌的想法，闡述透過溫柔的深層呵護能使肌膚健康、輕透、水嫩。愛護全家人一起防護也超精省，更可分享給朋友神奇力量的柔細與光澤做為餽贈好禮。</div>
                       </div>
