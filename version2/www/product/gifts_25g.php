...
<head>
    ...
    <script>
		...
		var selectionChangedB = function() {
            ...
            var oSlot4 = document.getElementById("id_slot4B");
            if (oSlot4.value != "0") {
                sum += getPrice(oSlot4.value);
            } //if
    ...
    <div class="wrapper style5">
        <article class="content container 75%">
            <div class="row not-mobile">
                <div class="5u">
                    <img id="productImage" class="12u" src="images/PIC00-10-3.png">
                </div>
                <div class="7u">
                    <div class="row">
                        <div class="12u fr42">
                            <ul class="fr49 item">
                                <li id="best">BEST</li>
                                <li>
                                    <h3>Optional　-Vibrant skin set 25g</h3>
                                </li>
                            </ul>
                            <ul class="item">
                                <li>
                            ...
                            <p>深受小資美女喜愛的Candy糖果盒裝，活潑搭配25g隨選5入式組合，讓全面溫柔呵護肌膚健康 水嫩的概念不受限，一次享受多重體驗，眷戀自我與分享好友，全面滿足。
                                <font style="color:brown;font-size:1.25em">人氣首選!</font>
                            </p>
                            <div class="row fr403">
                                <div class="8u">
                        ...
                        <div class="row">
                            <div class="12u" id="options">
                                <ul>
                                    ...
                                    <li>
                                        <select class="12u" name="slot[4]" id="id_slot4B" onChange="selectionChangedB()">
                                      <option value="0">--請選擇--</option>
                                      <option value="gardenia25">梔子花25g</option>
                                      <option value="rose25">玫瑰花25g</option>
                                      <option value="lemongrass25">檸檬草25g</option>
