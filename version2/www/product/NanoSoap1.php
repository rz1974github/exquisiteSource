	...
	<!-- Home -->
		<div class="wrapper style5">
	      <article class="content container 75%">
		     <div class="row">
			    <div class="4u 6u(2) 12u(3)"><img id="productImage" class="12u 6u(3)" src="images/100-1-1_326x326.png"></div>
				<div class="8u 10u(2) 12u(3)">
                   ...
                   <div class="row 50%">
                      <span class="price">售價　TWD NT$ 280</span>
                   </div>
				   ...
				   <div class="row 25%">
					  <div class="8u"><span>請選擇香氛</span>
						 <div class="row 25% no-collapse">
                            ...
                            <input type="radio" name="product" value="gardenia100" onChange="selectionChanged()"
                            <?php echo (!isset($_POST['product']))||($_POST['product']=="gardenia100")? "checked":""; ?> ></label>
							</div>
							<div class="2u"><label><img class="12u" src="images/icon06.png"><br>
							<input type="radio" name="product" value="rose100" onChange="selectionChanged()"
                            <?php echo ($_POST['product']=="rose100")? "checked":""; ?> ></label>
							</div>
							<div class="2u"><label><img class="12u" src="images/icon07.png"><br>
							<input type="radio" name="product" value="lavender100" onChange="selectionChanged()"
                            <?php echo ($_POST['product']=="lavender100")? "checked":""; ?> ></label>
							</div>
							<div class="2u"><label><img class="12u" src="images/icon08.png"><br>
							<input type="radio" name="product" value="lemongrass100" onChange="selectionChanged()"
                            <?php echo ($_POST['product']=="lemongrass100")? "checked":""; ?> ></label>
							</div>
							<div class="2u"><label><img class="12u" src="images/icon10.png"><br>
							<input type="radio" name="product" value="magnolia100" onChange="selectionChanged()"
                            <?php echo ($_POST['product']=="magnolia100")? "checked":""; ?> ></label>
							</div>
							<div class="2u"><label><img class="12u" src="images/icon11.png"><br>
							<input type="radio" name="product" value="cypress100" onChange="selectionChanged()"
                            <?php echo ($_POST['product']=="cypress100")? "checked":""; ?> ></label>
							</div>
						 </div>
					  </div>
				   </div> <!-- row 25%-->				   
