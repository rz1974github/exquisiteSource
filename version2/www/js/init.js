...
(function($) {
	...
	/*skel.init({
		...
		breakpoints: {
			...
			'wide': 	{ range: '1681-', 		href: 'css/style-wide.css', 	containers: 1200 },
			'normal': 	{ range: '1201-1680', 	href: 'css/style-normal.css', 	containers: 1200 ,	grid: {	zoom:2}},
			'1000px':	{ range: '737-1200',	href: 'css/style-narrower.css', containers: 737, 	grid: { gutters: 25 , zoom:3 }},
			'mobile':	{ range: '-736', 		href: 'css/style-mobile.css', 	containers: '100%!',grid: { collapse: true, gutters: 15, zoom:4}, viewport: { scalable: false }}
			*/					
			/*
			'global': 	        { range: '*', 			href: 'css/style.css', 								         grid: { gutters: 40} },
			'wide': 	        { range: '1681-', 		href: 'css/style-wide.css', 	        containers: 1200 },
			'normal': 	        { range: '1281-1680', 	href: 'css/style-normal.css', 	        containers: 1200 ,	 grid: {	zoom:2}},
			'narrow':           { range: '1001-1280',   href: 'css/style-narrow.css',           containers: 960,     grid: { collapse: true, gutters: 30 , zoom:3} },
			'small-narrower':   { range: '841-1000',    href: 'css/style-mobile-narrower.css',  containers: 800,     grid: { collapse: true, gutters: 25 , zoom:4 }},
			'1000px':	        { range: '737-840',	    href: 'css/style-narrower.css',         containers: 737, 	 grid: { collapse: true, gutters: 20 , zoom:5 }},
			'mobile':	        { range: '480-736', 	href: 'css/style-mobile.css', 	        containers: '100%!', grid: { collapse: true, gutters: 15,  zoom:6 }, viewport: { scalable: false }},
			'mobile-narrow':    { range: '-479',        href: 'css/style-mobile-narrow.css',    containers: '100%!', grid: { collapse: true, gutters: 10,  zoom:7 }, viewport: { scalable: false }},
	...
	/*skel.init({
		...
		breakpoints: {
			...
			/*'narrower': { range: '-1000',       href: 'css/style-narrower.css', containers: '95%' },*/
			/*'mobile':   { range: '-736',        href: 'css/style-mobile.css',   grid: { gutters: 20 }},*/
			/*'mobile-narrow': { range: '-480',   href: 'css/style-mobile-narrow.css',  grid: { collapse: true, gutters: 10, zoom:5 }},
		}
	});*/
